...
tlims = [5.0] # end time
births    = np.array([1.0, 2.0, 10.0])*1e6 # birth rate
deaths    = [0.2] # death rate
dyn       = ["poisson_thinned"] # clone dynamics

runcombinations_array(run, (births, deaths, intros, introsizes, tlims, dyn ), ('birth', 'death', 'intro', 'introsize', 'tlim', 'dyn'), datadir='data/', outname='earlydeath')
